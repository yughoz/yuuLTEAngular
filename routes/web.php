...
Route::get('/redis', 'TestedController@redis');


Auth::routes();

Route::get('/angular', 'HomeController@index');
Route::get('/home', 'HomeController@index')->name('home');
Route::get('/dashboard', 'HomeController@dashboard');
// Route::get('/home', 'DummyController@dummy0');
Route::get('/dummy1', 'DummyController@dummy1');
Route::get('/dummy2', 'DummyController@dummy2');
Route::get('/dummy3', 'DummyController@dummy3');
...
Route::get('/admin/chat', 'ChatsController@index')->middleware('role:chats');
