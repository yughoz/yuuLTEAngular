    ...
    <div class="register-box">
        ...
        <div class="register-box-body">
            ...
            <form action="<?php echo e(url(config('adminlte.register_url', 'register'))); ?>" method="post">
                ...
                <div class="form-group has-feedback <?php echo e($errors->has('sex') ? 'has-error' : ''); ?>">
                    <input type="text" name="phone" id="phone" pattern="^((\+\d{1,3}(-| )?\(?\d\)?(-| )?\d{1,5})|(\(?\d{2,6}\)?))(-| )?(\d{3,4})(-| )?(\d{4})(( x| ext)\d{1,5}){0,1}$" class="form-control" value="<?php echo e(old('phone')); ?>"
                           placeholder="phone"/>
                ...
                <div class="form-group has-feedback <?php echo e($errors->has('sex') ? 'has-error' : ''); ?>">
                    ...
                    <span class="glyphicon glyphicon-sex form-control-feedback"></span>
