...
<?php $__env->startSection('adminlte_js'); ?>
    ...
    <script src="<?php echo e(asset('vendor/angular/1.6.9/angular.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/angular/1.6.9/angular-route.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/angular/libs/angular-ui-router/1.0.3/angular-ui-router.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/angular/libs/oclazyload/1.1.0/ocLazyLoad.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/adminlte/dist/js/adminlte.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/angular/1.6.9/angular-animate.min.js')); ?>"></script>
