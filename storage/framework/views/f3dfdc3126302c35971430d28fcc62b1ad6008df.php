...
<?php echo $__env->yieldContent('title_postfix', config('adminlte.title_postfix', '')); ?></title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('vendor/adminlte/vendor/datatables/dataTables.bootstrap.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('vendor/adminlte/vendor/angular-loading-bar-master/src/loading-bar.js')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('vendor/adminlte/vendor/angular-loading-bar-master/build/loading-bar.min.css')); ?>"  media='all'>
    ...
    <?php echo $__env->yieldContent('costom_js'); ?>
