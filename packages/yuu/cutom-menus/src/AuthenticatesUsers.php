...
trait AuthenticatesUsers
{
    ...
    protected function sendLoginResponse(Request $request)
    {
        ...
        if ($sessionSetLogin = $this->sessionSetLogin($request)) {
            return $sessionSetLogin;
        }
    ...
    {   
        ...
        if ($user->active != 1) {
             $errors = [$this->username() => "User Not active"];
        ...
        $user->group_collor         = $groups->bgcolor ?? config('adminlte.default_group') ;
