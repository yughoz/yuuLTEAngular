    ...
    */
    ...
    public function anyData()
    {
        ...
        return Datatables::of($role)
            ...
            //         return '<a href="#edit-'.$role->id.'" class="btn btn-xs btn-primary" onclick="roles_list.editModal('.$role->id.')"><i class="glyphicon glyphicon-edit"></i> Edit</a> <a href="#delete-'.$role->id.'" class="btn btn-xs btn-danger" onclick="roles_list.deleteModal('.$role->id.')"><i class="glyphicon glyphicon-remove"></i> Delete</a>';
            //     })
            ...
            ->editColumn('createAcc', function ($role) {
                ...
                $activeHTML = '<a onclick="roles_list.changeStatus('.$role->id.','."'createAcc'".')"><input type="checkbox" class="btnC" '.$checked.' id="createAcc'.$role->id.'"></a>';
            ...
            ->editColumn('readAcc', function ($role) {
                ...
                $activeHTML = '<a onclick="roles_list.changeStatus('.$role->id.','."'readAcc'".')"><input type="checkbox" '.$checked.' class="btnC" id="readAcc'.$role->id.'"></a>';
                return checkAccess('roles','editAcc') ? $activeHTML : $checkedHtml;
                })
            ->editColumn('updateAcc', function ($role) {
                ...
                $activeHTML = '<a onclick="roles_list.changeStatus('.$role->id.','."'updateAcc'".')"><input type="checkbox" '.$checked.' class="btnC" id="updateAcc'.$role->id.'"></a>';
                return checkAccess('roles','editAcc') ? $activeHTML : $checkedHtml;
                })
            ->editColumn('deleteAcc', function ($role) {
                ...
                $activeHTML = '<a onclick="roles_list.changeStatus('.$role->id.','."'deleteAcc'".')"><input type="checkbox" '.$checked.' class="btnC" id="deleteAcc'.$role->id.'"></a>';
                return checkAccess('roles','editAcc') ? $activeHTML : $checkedHtml;
                })
            ->escapeColumns([])
            ->make(true);
